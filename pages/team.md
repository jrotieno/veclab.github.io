...
<div class="row t30">
<div class="small-2 columns"><div style="background: #E4E4E4; height: 137px;"><a href="{{ site.url }}/james-nokes"><img class="publication" src="{{ site.url }}/images/James-Nokes.jpg" alt=""></a></div><a href="{{ site.url }}/james-nokes">Prof James Nokes</a><div>Group Leader(PI)</div></div>
...
<div class="small-2 columns"><div style="background: #FFFFFF; height: 137px;"><a href="{{ site.url }}/joyce-nyiro"><img class="publication" src="{{ site.url }}/images/Joyce-Nyiro.jpg" alt="" height="100" width="100"></a></div><strong><a>Joyce Nyiro</a></strong><div>Research officer</div></div> 
